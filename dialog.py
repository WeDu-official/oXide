...
from widgets import (MessageBox, Label, RadioButton, PushButton, 
                     ListWidget, blueLabel, TabWidget, TextEdit)
...
class SettingsDialog(Dialog):
    ...
    def createTextPadGroup(self):
        ...
        label1 = Label('Width for <Tab> in bluespaces:')
        ...
        label3 = blueLabel('Changes in this area will be appear on\nrestart or new Tab')
        vbox = QVBoxLayout()
...
#################################
        ...
        codeeditor_text = '''
        oXide - The cross platform Python IDE
        
        oXide is an Editor and Integrated Development Environment (IDE)
        ...
        settings (-> which where saved in oXide.ini => it's a text file)
        ...
        Programmed 2024 by WeDu
        
        oXide was completely coded in Python using
